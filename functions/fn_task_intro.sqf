...
if (hasInterface) then {
    [] spawn {
        ...
        // ==============================================================================================
        sleep 0.5;  // Court délai pour stabilisation
        ...
        // Cible 2 : Position aléatoire pour le survol de ville (départ)
        private _randomPosIndex1 = floor (random 177);
        private _posName1 = format ["task_bomb_position_%1", _randomPosIndex1];
        ...
        // Cible 3 : Position aléatoire pour le survol de ville (arrivée)
        private _randomPosIndex2 = floor (random 177);
        while { _randomPosIndex2 == _randomPosIndex1 } do { _randomPosIndex2 = floor (random 177); };
        private _posName2 = format ["task_bomb_position_%1", _randomPosIndex2];
        ...
        // Note: _targetCityMid et _targetCityEnd déjà définis au-dessus avec positions aléatoires
