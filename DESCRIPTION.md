[h1]⚡ SITREP: OPERATION "ACUTE STRESS DISORDER"[/h1]

[b]Soldat, bienvenue à Sefrou-Ramal.[/b] Oubliez les règles d'engagement conventionnelles. Ici, il n'y a pas de ligne de front définie. Pas de zone de sécurité garantie. Vous ne combattez pas une armée, vous combattez la paranoïa elle-même.

Dans ce théâtre d'opérations asymétrique, [b]le danger est partout et nulle part[/b]. Votre capacité à distinguer un civil d'une menace mortelle sera la seule chose qui vous séparera du "Game Over".
...
[h3]🌍 GUERRE UNIVERSELLE (TRADUCTION)[/h3]
Le conflit ne connaît pas de barrière de langue. Cette mission est entièrement traduite :
...
[quote][b]RAPPEL :[/b] "Acute Stress Disorder" n'est pas juste un nom de code. C'est ce qui vous attend.[/quote]
